...
import { LayoutDashboard, Package, Grid3X3, CheckSquare, ArrowUpRight, Settings, LogOut, X, ArrowLeft } from "lucide-react";
    ...
    <>
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-[220px] bg-card border-r border-border z-50 flex flex-col">
        ...
        <div className="px-2 pb-4 mt-auto border-t border-border pt-2">
          ...
          <button className="sidebar-link w-full text-red-500"><LogOut className="w-4 h-4" /><span>Logout</span></button>
        </div>
      </aside>
    </>
  );
