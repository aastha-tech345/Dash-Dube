...
export default function CreateShelf() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        `${isEditMode ? "Updating" : "Creating"} shelf data:`,
        formData,
      );
      ...
      // Navigate to Infrastructure page with Abhi tab active
      navigate("/infrastructure?tab=Abhi");
    } catch (err) {
      console.error(
          ...
          <div className="flex items-center gap-3 mb-6">
            <div>
              <p className="text-xs text-muted-foreground mb-1">
                Infrastructure &gt; Abhi &gt;{" "}
                {isEditMode ? "Edit" : "Create New"} Shelf
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="page-subtitle">
                    {isEditMode
                      ? "Update shelf information and settings."
                      : "Define a new storage shelf within your warehouse rack."}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("rackId", parseInt(e.target.value))
                    }
                    required
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("shelfCode", e.target.value)
                    }
                    required
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("levelNo", parseInt(e.target.value))
                    }
                  />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Determines the order for picking operations.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("maxWeight", parseFloat(e.target.value))
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("maxVolume", parseFloat(e.target.value))
                    }
                  />
                </div>
              </div>
